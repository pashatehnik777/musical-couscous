...
def inch_swap_sell(privatekey, amount_to_swap, fromTokenAddress, to_symbol):
    try:
        ...
        token = web3.eth.contract(address=fromTokenAddress, abi=ABI)
...
if __name__ == "__main__":
    ...
    with open("D:\\Crypto-scripts\\guild-arbitrum-swaps-main\\private_keys.txt", "r") as f:
    ...
    for privatekey in keys_list:
        ...
        for swap in swaps_1inch_sell:
            ...
            to_symbol = swap['symbol']
            tx_cost.append(amount_to_swap)
            inch_swap_sell(privatekey, amount_to_swap,
                           to_token_address, to_symbol)
            time.sleep(random.randint(4, 10))
